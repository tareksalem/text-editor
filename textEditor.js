...
function textEditor(options) {
    ...
    window.addEventListener("load", function () {
        ...
        for (var element in editorTools) {
            ...
            editorTools[element].element.style.cssText = "padding:6px;background-color:white;margin:5px;border:1px solid #cecece;cursor:pointer;border-radius: 5px;font-size:12px;";
        ...
        container.style.cssText += "border:1px solid #cecece;margin-bottom:0px;background-color:rgb(247, 247, 247);height:auto;padding:10px"
